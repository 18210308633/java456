...
function add(){
	...
	layer.open({
	  ...
	  shade: 0.8,
	  area: [w+'px', h+'px'],
	  content: '/java456/houtai/user/add' //iframe的url
	});
}
...
function edit(id){
	...
	layer.open({
	  ...
	  shade: 0.8,
	  area: [w+'px', h+'px'],
	  content: '/java456/houtai/user/edit?id='+id //iframe的url
	});
}
...
function del(ids){
	...
	$.post('/java456/admin/user/delete',{ids:ids},function(result){
		if(result.success){
			layer.closeAll();
			layer.msg('删除成功');
			reload_data();
...
function set_persm(id){
	...
	layer.open({
		  ...
		  shade: 0.8,
		  area: [w+'px', h+'px'],
		  content: '/java456/houtai/user/setPersm?id='+id //iframe的url
	}); 
}
...
function set_ps(id){
	...
	layer.open({
		  ...
		  shade: 0.8,
		  area: [w+'px', h+'px'],
		  content: '/java456/houtai/user/setPassword?id='+id //iframe的url
	}); 
}


function table_edit_update(id,field,value){
	$.post('/java456/admin/user/update?'+field+'='+value,{id:id},function(result){
		if(result.success){
			layer.msg('修改成功');
		}else{
			layer.closeAll();
